...
class Leg3:
    ...
    def __init__(self, params):
        ...
        self.servoOffsets = params["servoOffsets"]
        self.servoLimits = params["servoLimits"]

    def forward(self, a, b, g, deg=True):
        """
        Forward kinematics of the leg where angles a,b,c can be degrees [default]
        or radians.
        """
        Lc, Lf, Lt = self.linkLengths
